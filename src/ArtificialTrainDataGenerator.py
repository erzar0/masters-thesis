...
class ArtificialTrainDataGenerator:
    ...
    @staticmethod
    def generate_sample(energy_range, elements, percentages, mu_global_err, mu_local_err, sigma_range, use_cache=False):
        ...
        if samples <= batch_size:
            ...
            for count in tqdm(counts, desc="Generating Samples"):
                ...
                sample, label = ArtificialTrainDataGenerator.generate_sample(
                    energy_range, selected, percentages, mu_err, mu_local_err, sigma_range, use_cache
                )
